    ...
    do {
      ...
      try {
        ...
        switch (choice) {
          ...
          case 2:
            System.out.println(
              "Please enter the word to add in the dictionary:"
            );
            String word = sc.next();
          ...
          case 3:
            System.out.println(
              "Please enter the word to search in dictionary:"
            );
            String key = sc.next();
          ...
          case 4:
            System.out.println(
              "Please enter the word to delete from dictionary:"
            );
            String del = sc.next();
